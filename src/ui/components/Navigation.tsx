  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e6e9f4] px-10 py-3">
      <div className="flex items-center gap-4 text-[#0d0f1c]">
        ...
        <h2 className="text-[#0d0f1c] text-lg font-bold leading-tight tracking-[-0.015em]">afterbootcamp.es</h2>
      </div>
      <div className="flex flex-1 justify-end gap-8">
        ...
        <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-[#4768fa] text-[#f8f9fc] text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#3a56d4] transition-colors">
